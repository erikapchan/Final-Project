...
Next I found the first policy-related speech listed when the name of the Congresswoman is searched on YouTube. To try and control for misogyny directed at policies and the content of the video, rather than the policymaker delivering the information, I excluded speech on heavily gendered issues, such as Grace Meng’s video on menstrual equity. Instead, I used the second video. Another issue I encountered was that some of the videos had the comments turned off, and I used the second video listed instead. I chose to look at YouTube comments as the data was easily accessible and YouTube has broad user interaction. 
...
<img width="411" alt="image" src="https://github.com/erikapchan/Final-Project/assets/144921862/abb88e30-698c-45a1-a7a2-726a5cf9b02c">
...
<img width="414" alt="image" src="https://github.com/erikapchan/Final-Project/assets/144921862/ada2a4a7-cb01-4fe3-a064-6e4f8c67d4cf">
...
Another limitation is in the casual nature of internet comments and use of slang. After data cleaning, I looked at the remaining comments, and saw words with exaggerations, typos, or slang mispelling such as "moneyyyyyyy" and "stoopid." The TFIDF tools will detect these as different from "money" and "stupid" respectively. There were a number of comments that used such words.
...
### References
“Bar Plot in Matplotlib.” GeeksforGeeks, GeeksforGeeks, 4 Mar. 2021, www.geeksforgeeks.org/bar-plot-in-matplotlib/. 
